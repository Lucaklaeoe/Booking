...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 841.89 595.28">
  ...
  <g id="grupperum">
    <rect className="cls-3" x="478.73" y="394.94" width="68.41" height="29.28"/>
    <rect className="cls-3" x="620.3" y="410.44" width="29.13" height="33.91"/>
    <rect className="cls-3" x="531.66" y="480.29" width="27.83" height="30.92"/>
    <rect className="cls-3" x="559.49" y="480.36" width="27.49" height="30.92"/>
  </g>
  <g id="Lokaler">
    <rect className="cls-4" x="487.54" y="511.38" width="80.51" height="51.09"/>
    <rect className="cls-4" x="568.29" y="511.38" width="80.81" height="51.09"/>
    <rect className="cls-4" x="593.7" y="293.07" width="55.37" height="77.28"/>
    <rect className="cls-4" x="593.49" y="224.22" width="55.37" height="68.91"/>
    <rect className="cls-4" x="484.76" y="227.68" width="61.84" height="70.17"/>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.10 clicked')} className="cls-6" transform="translate(609.1 335.54)"><tspan x="0" y="0">3.10</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.9 clicked')} className="cls-6" transform="translate(625.38 431.22)"><tspan x="0" y="0">3.9</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.13 clicked')}className="cls-6" transform="translate(503.39 266.59)"><tspan x="0" y="0">3.13</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.3 clicked')} className="cls-6" transform="translate(503.47 413.41)"><tspan x="0" y="0">3.3</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.6 clicked')} className="cls-6" transform="translate(563.37 501.36)"><tspan x="0" y="0">3.6</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.5 clicked')} className="cls-6" transform="translate(536.11 499.58)"><tspan x="0" y="0">3.5</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.4 clicked')} className="cls-6" transform="translate(518.18 540.76)"><tspan x="0" y="0">3.4</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.7 clicked')}className="cls-6" transform="translate(599.37 540.76)"><tspan x="0" y="0">3.7</tspan></text>
    <text style={{cursor: 'pointer'}} onClick={() => console.log('Lokale 3.11 clicked')} className="cls-6" transform="translate(609.94 262.51)"><tspan x="0" y="0">3.11</tspan></text>
  </g>
</svg>
    </div>
)
